...
class Gallery extends Component {
    ...
    playAudio(track)
    {
        ...
        this.props.onActivateTrack(activeTrackId);
            ...
            <div>
                {tracks != null
                    ? (Object.keys(tracks).map((key, index) => {
                        ...
                        return (
                            <div key={index} className="track" onClick={() => this.playAudio(track)}>
...
function mapDispatchToProps(dispatch) {
    return {
        onActivateTrack: bindActionCreators(activateTrack, dispatch),
        onSetTopTracks: bindActionCreators(setTopTracks, dispatch)
    };
}

function mapStateToProps(state) {
    return {isPlaying: state.player.isPlaying, activeTrackId: state.player.activeTrackId};
}
